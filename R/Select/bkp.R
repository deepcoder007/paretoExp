...
mse_alpha_0 <- mean( (theta_big$alpha_0 - theta_orig[1])**2 )
mse_alpha_1 <- mean( (theta_big$alpha_1 - theta_orig[2])**2 )
mse_alpha_2 <- mean( (theta_big$alpha_2 - theta_orig[3])**2)
mse_mu_1 <- mean( (theta_big$mu_1 - theta_orig[4])**2 )
mse_mu_2 <- mean( (theta_big$mu_2 - theta_orig[5])**2 )
mse_sigma_1 <- mean( (theta_big$sigma_1 - theta_orig[6])**2 )
mse_sigma_2 <- mean( (theta_big$sigma_2 - theta_orig[7])**2 )